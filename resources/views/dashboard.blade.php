...
<div class="wrapper"> 
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
        ...
        <a href="#" class="brand-link">
            <img src=" {{ asset('img/AdminLTELogo.png') }}" alt="AdminLTE Logo"
                class="brand-image img-circle elevation3" style="opacity: .8">
            <span class="brand-text font-weight-light">ATMA KITCHEN</span>
        </a>
        <!-- Sidebar -->
        <div class="sidebar">
            <!-- Sidebar Menu -->
            <nav class="mt-2">
                <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                    ...
                    <li class="nav-item">
                        <a href="{{ url('hampers') }}" class="nav-link">
                            <i class="fa-solid fa-ticket"></i>
                            <p>Hampers</p>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a href="{{ url('pembelianBahanBaku') }}" class="nav-link">
                            <i class="fa-solid fa-ticket"></i>
    ...
    <footer class="main-footer">
        <!-- To the right -->
        <div class="float-right d-none d-sm-inline"> Atma Kitchen
        </div>
        <!-- Default to the left -->
